...
var SingleError = t.string;
var Errors =
/*#__PURE__*/
t.readonlyArray(t.string);
var ValidationErrors =
/*#__PURE__*/
t.recursion('ValidationErrors', function () {
  return t.record(t.string, t.union([SingleError, Errors, ValidationErrors]));
});
var ServerErrors =
/*#__PURE__*/
t.union([t.string, SingleError, Errors, ValidationErrors]);

function serverError(error) {
  t.cast(ServerErrors, error);
  ...
  if (ValidationErrors.is(error)) {
    return t.keys(error.validationErrors).map(function (k) {
...
function useRedirect() {
  var history = devfractalRouter.useHistory();
  return {
...
exports.Patch = Patch;
exports.PatchReset = PatchReset;
exports.Post = Post;
exports.PostReset = PostReset;
exports.Put = Put;
exports.PutReset = PutReset;
exports.ServerError = ServerError;
exports.useDel = useDel;
exports.useGet = useGet;
exports.useRedirect = useRedirect;
exports.useSubmit = useSubmit;
exports.useSubmitRedirect = useSubmitRedirect;
exports.useSubmitReset = useSubmitReset;
//# sourceMappingURL=devfractal-ui-api.cjs.development.js.map
